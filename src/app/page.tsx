...
const Main = () => {
  ...
  return (
      <main className="flex min-h-screen flex-col items-center justify-between p-12 font-mono">
        ...
        <h2 className="text-sm mb-3">Check out the source code at <a className="text-blue-600" href="https://github.com/sweepai/prompt-lab">https://github.com/sweepai/prompt-lab</a></h2>
        <div className="h-screen w-full flex">
          ...
          <div className="w-2/3 p-4">
            ...
            <input 
              ...
              value={apiKey}
              onChange={(e) => {
                setRunButtonDisabled(e.target.value === "" || messages.length === 0 || isRunning);
